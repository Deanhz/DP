...
def main():
    ...
    train_epoch_size = train_batch_len // TRAINING_NUM_STEP

    valid_data_len = len(valid_data)
    valid_batch_len = valid_data_len // EVAL_BATCH_SIZE
    valid_epoch_size = valid_batch_len // EVAL_NUM_STEP

    test_data_len = len(test_data)
    test_batch_len = test_data_len // EVAL_BATCH_SIZE
    test_epoch_size = test_batch_len // EVAL_NUM_STEP
